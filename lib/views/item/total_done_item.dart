...
import '../../core/models/total_done.dart';
import '../../core/models/waiting_model.dart';

class TotalDoneWorkItem extends StatelessWidget {
  final TotalDone totalDoneTaskModel;
  const TotalDoneWorkItem({super.key, required this.totalDoneTaskModel});
